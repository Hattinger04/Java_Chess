...
/**
 * Enum, wo zwischen den 2 Farben unterschieden wird
 * 
 */
public enum Farbe {
	WHITE {
		...
		@Override
		public Player choosePlayer(final WhitePlayer weisserSpieler, final BlackPlayer schwarzerSpieler) {
	...
	public abstract Player choosePlayer(final WhitePlayer weisserSpieler, final BlackPlayer schwarzerSpieler);
	
	public abstract boolean isPawnPromotionSquare(int position);
	
	/*
	 * Gibt an, an welcher Position jede Figur jeder Farbe am besten steht, 
	 * was dann fuer den Algorithmus verwendet wird.
	 * 
	 */
	
	private final static int[] WHITE_PAWN_PREFERRED_COORDINATES = { 0, 0, 0, 0, 0, 0, 0, 0, 75, 75, 75, 75, 75, 75, 75,
			75, 25, 25, 29, 29, 29, 29, 25, 25, 5, 5, 10, 55, 55, 10, 5, 5, 0, 0, 0, 20, 20, 0, 0, 0, 5, -5, -10, 0, 0,
	...
	private final static int[] BLACK_PAWN_PREFERRED_COORDINATES = { 0, 0, 0, 0, 0, 0, 0, 0, 5, 10, 10, -20, -20, 10, 10,
			5, 5, -5, -10, 0, 0, -10, -5, 5, 0, 0, 0, 20, 20, 0, 0, 0, 5, 5, 10, 55, 55, 10, 5, 5, 25, 25, 29, 29, 29,
			29, 25, 25, 75, 75, 75, 75, 75, 75, 75, 75, 0, 0, 0, 0, 0, 0, 0, 0 };
